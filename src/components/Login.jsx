...
function Login(props) {
  ...
  return (
    <div className="filter-none pointer-events-auto z-10 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] transition-all duration-500 ease-in-out">
      <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-xl bg-white p-8 border border-netural-500">
        ...
        <CgCloseO
          ...
          className="w-6 h-6 absolute right-[3%] top-[3%] cursor-pointer text-black hover:text-red-700"
        />
        ...
        <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
          ...
          <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
            ...
            <a
              className="font-medium text-blue-500 transition-colors hover:text-red-700"
              href="#"
            >
              Reset Here
            </a>
